...
/// <summary>
/// Calculates ROI metrics for short-term rental properties.
/// </summary>
public sealed class RoiCalculator : IRoiCalculator
{
    /// <inheritdoc />
    public RentalResult Calculate(RentalInputs input)
    {
        Validate(input);
